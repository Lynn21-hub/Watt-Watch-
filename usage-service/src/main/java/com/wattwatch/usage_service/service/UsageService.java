package com.wattwatch.usage_service.service;
...
import com.wattwatch.kafka.event.AlertingEvent;
import com.wattwatch.kafka.event.EnergyUsageEvent;
import com.wattwatch.usage_service.client.DeviceClient;
import com.wattwatch.usage_service.client.UserClient;
import com.wattwatch.usage_service.dto.DeviceDto;
import com.wattwatch.usage_service.dto.UsageDto;
import com.wattwatch.usage_service.dto.UserDto;
import com.wattwatch.usage_service.model.Device;
import com.wattwatch.usage_service.model.DeviceEnergy;
...
public class UsageService {
 ...
 // implement the kafka listener for energy usage events
    ...
    public void aggregateDeviceEnergyUsage() {
        ...
        //define bucket from where we will get this data 
        //define a range which is a start time and an end time
        //device can have multiple readings within the specified range
        //we will aggregate the energy consumed for each device within this range
        ...
        //query the InfluxDB and get the results as FluxTables

        // translate table data into DeviceEnergy objects
        List<DeviceEnergy> deviceEnergies = new ArrayList<>();
        // iterate over each table and record to extract device energy usage
        ...
        // fetch user information for each device to associate userId with device energy usage
        ...
        // remove devices with null userId to ensure only valid user-device associations are considered
